...
const noMessages = [
    ...
    "Lubna… that button is starting to look suspicious 😏",
                ...
                <main className="relative z-10 w-[92vw] max-w-xl rounded-3xl p-8 text-center shadow-2xl bg-white/80 backdrop-blur-xl">
                    ...
                    {step === "intro" && (
                        <div className="animate-pop">
                            <h1 className="text-4xl font-extrabold mb-6">Hey Lubna 💕</h1>
                    ...
                    {step === "celebration" && (
                        <div className="animate-pop">
                            ...
                            <img
                                ...
                                src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZjc2aHVqeHJ2cml4cndmOW1xOHd6OXV6NTRuMzlrZnM4c205YTZqOCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/ytu2GUYbvhz7zShGwS/giphy.gif"
                                alt="Fireworks"
                            />
                        </div>
                    )}
